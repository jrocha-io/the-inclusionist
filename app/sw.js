...
const CACHE = 'inclusionist-v4.163.4'; // = versão do jogo (bump A CADA commit invalida o cache antigo)
const SHELL = [
  ...
  'js/platform/storage.js', 'js/core/state.js', // persistência + estado (Fase 2)
