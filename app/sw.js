...
const CACHE = 'inclusionist-v4.161.2'; // = versão do jogo (bump A CADA commit invalida o cache antigo)
const SHELL = [
  ...
  'js/core/constants.js', 'js/core/world.js', // constantes + mundo puros (modularização Fase B)
