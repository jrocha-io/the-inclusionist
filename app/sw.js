...
const CACHE = 'inclusionist-v4.164.6'; // = versão do jogo (bump A CADA commit invalida o cache antigo)
const SHELL = [
  ...
  'js/render/viz-modes.js', 'js/input/devices.js', // modos visuais + rótulos de gamepad/toque (Fase 2)
