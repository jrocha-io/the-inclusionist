...
const CACHE = 'inclusionist-v4.164.24'; // = versão do jogo (bump A CADA commit invalida o cache antigo)
const SHELL = [
  ...
  'js/input/state.js', // estado de input em runtime (keys/padCur + held) (Fase 2.22)
