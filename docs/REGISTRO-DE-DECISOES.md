...
| **Wizard de mapeamento por modelo de controle** (gamepad.id): botões por índice, analógico por limiar (eixo+sinal), D-pad DirectInput como POV hat (valor de eixo ±0.13) | Gamepad API: `mapping:''` não padroniza índices; hat vira eixo com 8 passos ~0.286 | commit `7d7aff3` | ✅ |
