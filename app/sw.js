...
const CACHE = 'inclusionist-v4.164.17'; // = versão do jogo (bump A CADA commit invalida o cache antigo)
const SHELL = [
  ...
  'js/render/sprites.js', 'js/render/canvas.js', // texturas do personagem + primitivas de canvas (Fase 2.17/2.18)
