...
const CACHE = 'inclusionist-v4.164.11'; // = versão do jogo (bump A CADA commit invalida o cache antigo)
const SHELL = [
  ...
  'js/render/viz-modes.js', 'js/input/devices.js', 'js/platform/audio.js', // viz + devices + base de áudio (Fase 2)
