...
Este plano-mestre é a **espinha atual** e o roadmap canônico. Superou o `ROADMAP.md` (E1–E13) e o `PLANO-EXECUCAO.md`
(série L0–L9), **ambos já arquivados em `legacy/`**. Os planos detalhados por fase (`plano-*.md`) seguem valendo.
...
- **Movimento das nuvens duro + sumiço na metade da borda** → rastreado na **issue #21** (repro + locais lá). Fazer
  na Fase 2 (extração do render).
