...
The **doing** phase (SDD section d). Artifacts:

- **[TDD.md](TDD.md)** — TDD/XP, Vitest (node + browser), ZOMBIES + Right-BICEP; Test Case → `../3-Sprint-Design/Test-Plan.md`.
- **[Commits.md](Commits.md)** — Conventional Commits, atomic, `Closes #N` trace.
